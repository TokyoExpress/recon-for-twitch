# USAGE
# python test_network.py --model output/simple_neural_network.hdf5 --test-images tests
...
# CLASSES = ["league", "not in game"]
CLASSES = ["apex", "csgo", "fallguys", "fortnite", "league", "mw", "ow", "valorant"]
